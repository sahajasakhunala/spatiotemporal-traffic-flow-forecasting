...
- **Data Volume**: **11.97 million road-segment/hour records** representing approximately 24,938 segments across 20 days (August 11–30, 2024).
...
- **Scientific Integrity**:
  ...
  - Strict chronological evaluation: **Train (Aug 11–26: 8.97M rows)** vs **Test (Aug 27–30: 2.39M rows)**.
...
- `06_frc_traffic_variation.png` — Functional Road Class (FRC 1–6) volume hierarchy
