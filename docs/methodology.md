...
2. **Segment Statistics Isolation**: Target encoding and historical segment statistics ($\mu, \sigma, p_{90}, \text{zero\_freq}$) are estimated exclusively from the training date range (August 1126, 2024).
