...
class TestSumoSimulation(unittest.TestCase):
    ...
    def test_04_network_generation_and_xml_validity(self):
        ...
        # Regular corridor edges (excluding internal junction links generated by netconvert)
        regular_edges = [e for e in root_net.findall("edge") if not e.get("id", "").startswith(":")]
        self.assertEqual(len(regular_edges), 218)
